...
public class OObjects {
    ...
    public static final Item SILVER_INGOT = register("silver_ingot", new SilverItem(gen()));
    ...
    public static final Block GLANCE_SLAB = register("glance", new SlabBlock(copyOf(GLANCE)), true);
    public static final Block GLANCE_BRICKS_SLAB = register("glance", new SlabBlock(copyOf(GLANCE)), true);
    public static final Block GLANCE_STAIRS = register("glance", new StairBlock(GLANCE, copyOf(GLANCE)), true);
    ...
    public static final Block MOLTEN_LEAD_BLOCK = register("molten_lead_block", new MoltenLeadBlock(copyOf(GLANCE)), true);
    ...
    public static final Block BLACK_CRYSTAL_GLASS_PANE = register("black_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.BLACK), true);
    public static final Block BLUE_CRYSTAL_GLASS_PANE = register("blue_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.BLUE), true);
    public static final Block BROWN_CRYSTAL_GLASS_PANE = register("brown_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.BROWN), true);
    public static final Block CYAN_CRYSTAL_GLASS_PANE = register("cyan_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.CYAN), true);
    public static final Block GRAY_CRYSTAL_GLASS_PANE = register("gray_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.GRAY), true);
    public static final Block GREEN_CRYSTAL_GLASS_PANE = register("green_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.GREEN), true);
    public static final Block LIGHT_BLUE_CRYSTAL_GLASS_PANE = register("light_blue_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.LIGHT_BLUE), true);
    public static final Block LIGHT_GRAY_CRYSTAL_GLASS_PANE = register("light_gray_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.LIGHT_GRAY), true);
    public static final Block LIME_CRYSTAL_GLASS_PANE = register("lime_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.LIME), true);
    public static final Block MAGENTA_CRYSTAL_GLASS_PANE = register("magenta_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.MAGENTA), true);
    public static final Block ORANGE_CRYSTAL_GLASS_PANE = register("orange_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.ORANGE), true);
    public static final Block PINK_CRYSTAL_GLASS_PANE = register("pink_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.PINK), true);
    public static final Block PURPLE_CRYSTAL_GLASS_PANE = register("purple_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.PURPLE), true);
    public static final Block RED_CRYSTAL_GLASS_PANE = register("red_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.RED), true);
    public static final Block WHITE_CRYSTAL_GLASS_PANE = register("white_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.WHITE), true);
    public static final Block YELLOW_CRYSTAL_GLASS_PANE = register("yellow_crystal_glass_pane", new CrystalGlassPaneColoredBlock(copyOf(Blocks.GLASS), DyeColor.YELLOW), true);
    ...
    public static final Item BUSH_HAMMER = register("bush_hammer", new BushHammerItem(gen()));
